...
public enum TapticNotification { Success, Warning, Error }
public enum TapticImpact { Light, Medium, Heavy, None }
...
public static class TapticManager
{
    ...
    /*public static void OldVibrate()
    {
        if (Toolbox.Instance.statePersister.TapticEnabled)
        {
#if UNITY_IPHONE && !UNITY_EDITOR
    		_unityJustVibrate();
#endif
	...
	//[DllImport("__Internal")]
	//private static extern void _unityJustVibrate();
    [DllImport("__Internal")]
    ...
    //private static void _unityJustVibrate() { }

    private static bool _unityTapticIsSupport() { return Vibration.HasVibrator(); }
#endif
